...
EOF
echo ""
echo -e "${CYAN}  Unified Vulnerability Hunting Platform — 13 tools, one interface.${NC}"
echo -e "${CYAN}  ─────────────────────────────────────────────────────────────${NC}"
echo -e "${CYAN}  Developer: EliTechWiz (Eliah Hango)${NC}"
echo -e "${CYAN}  GitHub:    https://github.com/Eliahhango${NC}"
echo -e "${CYAN}  Website:   https://elitechwiz.com${NC}"
echo -e "${CYAN}  Telegram:  @techarmyy${NC}"
echo -e "${CYAN}  ─────────────────────────────────────────────────────────────${NC}"
echo ""
